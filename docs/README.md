...
npx gh-cp alias workflows owner/repo/.github/workflows
npx gh-cp install workflows .
```
...
- [Aliases and install](./features/aliases-and-install.md) — saved sources and the interactive alias picker
